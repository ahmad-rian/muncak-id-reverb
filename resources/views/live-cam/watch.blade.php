                    ...
                    <div class="card bg-white shadow-xl">
                        <div class="card-body p-0">
                            ...
                            <div class="relative aspect-video bg-black rounded-t-2xl overflow-hidden">
                                <video id="video-player" class="w-full h-full object-contain" autoplay playsinline muted></video>
                                ...
                                <!-- Offline Placeholder -->
                                <div id="offline-placeholder" class="absolute inset-0 flex flex-col items-center justify-center bg-black text-white hidden">
