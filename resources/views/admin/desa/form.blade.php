<x-layout.admin>
  ...
  <div class="flex justify-between gap-4 border-b border-base-300 pb-4">
    <p class="text-2xl font-semibold">{{ $type }} Desa</p>
  </div>
  ...
  <form class="mt-6" action="{{ $route }}" method="post">
    ...
    <div class="grid grid-cols-1 gap-4 md:grid-cols-2" x-data="namaSlug">
      ...
      <x-form.select :route="route('admin.api.kecamatan.select')" name="kode_kecamatan" label="Kecamatan" :value="old('kode_kecamatan', $data->kode_kecamatan)" />
