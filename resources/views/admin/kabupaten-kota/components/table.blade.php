        ...
        <tr class="hover">
          ...
          <td>
            <div class="flex gap-1 align-middle">
              <a class="btn btn-success btn-xs" href="{{ route('admin.kabupaten-kota.edit', $item->kode) }}">
                Edit
              </a>
              <a class="btn btn-secondary btn-xs" href="{{ route('admin.kabupaten-kota.show', $item->kode) }}">
                Lihat
              </a>
