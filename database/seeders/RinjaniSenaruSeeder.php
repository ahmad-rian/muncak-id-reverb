...
class RinjaniSenaruSeeder extends Seeder
{
    /**
    ...
    private function rinjani_senaru()
    {
        ...
        $rute = Rute::create([
            'gunung_id' => $gunung->id,
            'kode_desa' => "52.08.04.2006",
            'nama'      => 'Senaru',
            'slug'      => 'senaru',
            'deskripsi' => 'Rute Pendakian Senaru merupakan salah satu jalur pendakian utama menuju puncak Gunung Rinjani. Berawal dari desa Senaru yang terletak di utara Lombok, rute ini dikenal sebagai jalur yang relatif mudah diakses dan menawarkan pemandangan indah sepanjang perjalanan. Rute Senaru sering dipilih oleh para pendaki karena jalurnya yang bervariasi, mulai dari hutan tropis yang lebat hingga padang rumput yang terbuka. Selama pendakian, para pendaki dapat menikmati pemandangan spektakuler dari danau Segara Anak di kaldera Rinjani serta berbagai flora dan fauna unik. Jalur ini juga dilengkapi dengan beberapa tempat peristirahatan, termasuk pos-pos yang menyediakan fasilitas dasar untuk istirahat. Pendakian melalui rute Senaru umumnya memakan waktu sekitar 2-4 hari, tergantung pada rencana dan tingkat kesulitan yang dipilih.',
        ]);

        $filePath = base_path('database/seeders/file/rinjani-senaru.xlsx');
